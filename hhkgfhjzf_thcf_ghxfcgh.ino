...
int pinActual = startingOutputPin; // en esta variable guardamos el valor del pin que queremos activar
...
void lightPins() {
  ...
  if (currentTime - previousTime > interval) {
    ...
    if (pinActual > finishingOutputPin) {
      pinActual = finishingOutputPin;
    }
  }
}
...
void turnOffSequence() {
  ...
  if (currentTime - previousTime > interval) {
    ...
    if (pinActual < startingOutputPin) {
      pinActual = startingOutputPin;
    }
  }
}
